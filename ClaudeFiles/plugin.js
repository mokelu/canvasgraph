// Namespaced helpers for the plugin registry. Doesn't know or care
// whether `storage` is IndexedDB (browser) or the IPC-backed fs store
// (Electron) — that's the whole point of index.js.
